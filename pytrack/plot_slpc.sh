...
init0=2019100712
init1=2019101012
mmddhh0=`echo $init0 | cut -c5-10`
mmddhh1=`echo $init1 | cut -c5-10`
...
orig=jma
outfile=$orig/slpc${mmddhh0}-${mmddhh1}.ps

function plot_slpc() {
  tracktxt=$orig/track${1}_cntl.txt
  if [ -f ${tracktxt} ]; then
...
gmt psbasemap -R2019-10-06T18/2019-10-13T00/912/1012 -JX15c/10c -Y8c -Bxa1df6hg1d -Bya4f2g4 -K > ${outfile}
# best track
